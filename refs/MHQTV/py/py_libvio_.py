...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        url = 'https://tv.libvio.cc/type_{0}.html'.format(params)
        print(url)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
    ...
    def detailContent(self, array):
        tid = array[0]
        url = 'https://tv.libvio.cc/detail_{0}.html'.format(tid)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
        ...
        for vl in vodList:
            ...
            for tA in aList:
                if tA.xpath('./text()')[0]!="合集":
                    ...
                    tId = self.regStr(href, '/play_(\\S+).html')
    ...
    def playerContent(self, flag, id, vipFlags):
        result = {}
        url = 'https://tv.libvio.cc/play_{0}.html'.format(id)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
